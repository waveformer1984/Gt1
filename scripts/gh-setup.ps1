param(
  [string]$RepoSlug = "protoforge/heidi-launch"
)
$ErrorActionPreference = "Stop"

gh repo create $RepoSlug --private --disable-wiki
...
try {
  gh api -X PUT "repos/$RepoSlug/branches/main/protection/required_signatures" -f enabled=true
} catch {}
...
Write-Host "Repo hardened: $RepoSlug"
